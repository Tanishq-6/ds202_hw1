...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi Everyone. I'm **Tanishq Jain**, a transfer student from India. I'm a junior majoring in *statistics* with a minor in Data Science. I took all my classes online last year and just got back to ames last week, it feels good to be back on campus. My interests include Watching movies of 3 different languages, which is fun and also playing chess.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I think data analyst is a job related to data science who helps to transform and manipulate large amount of data which can be usefull in decision making.  
    
    [Career in Data Science](https://swordstoday.ie/7-best-reasons-to-make-your-career-in-data-science/)  
    
    ![Image](https://swordstoday.ie/wp-content/uploads/2021/05/datascience-pdusit-stock.jpg)
    
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I will be most interested in Finance.
